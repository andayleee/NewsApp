...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL("INSERT INTO News values(1,'Кот съел трамвай', '2022.06.15','На Новорижском шоссе сутра кот съел трамвай');");
        sqLiteDatabase.execSQL("INSERT INTO News values(2,'Собака съела торт', '2022.06.15','Сегодня сутра после недели делания отчетов собака поела! и поела она торт');");
    }
